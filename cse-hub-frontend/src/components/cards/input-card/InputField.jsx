...
const Inputbar = ({ placeholder, isPassword, value, onChange }) => {
  ...
  const handleChange = (e) => {
    console.log(`${placeholder} changed: `, e.target.value); // Debugging line
    onChange(e); // Ensure onChange is being triggered correctly
  };
  ...
  return (
    <>
      ...
      <input
        ...
        onChange={handleChange} // Pass the onChange prop here
        style={{
          width: "100%",
          padding: "4px 12px",
